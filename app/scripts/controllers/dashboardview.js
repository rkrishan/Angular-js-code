...
angular.module('specta')
    .controller('DashboardViewCtrl', function ($scope, $location, $http, $state, NgMap, globalConfig, $interval, $stateParams, ChartService, SweetAlert, UserProfile,$rootScope,socket,$timeout,NgTableParams) {
