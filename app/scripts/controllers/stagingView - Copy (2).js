...
angular.module('specta')
    .controller('StagingViewCtrl', function ($scope, $rootScope, $location, $state, $interval, filterService, $timeout,$sce, $stateParams, $filter, $uibModal, NgMap, globalData, globalConfig, ChartService, SweetAlert, UserProfile, socket, NgTableParams, httpService, dbService, highchartProcessData, currentUser, utility, dataFormatter){
    ...
    /*Highchart*/
        ...
        //stacked Bar
            function subscribeStackedBarHighchart( component ){
                ...
                if(component.fixOrder){
                    ...
                    httpService.get(url+'&db=datadb').success(function(res){
                        // console.log(res, component.title, component.ySeries)
            ...
            function highchartStackedBarReplace(component, data1){
                console.log('**********'+component.title, data1.length)
                $scope.displaydata[component._id].origionalData = angular.copy(data1);
                ...
                if( (angular.isDefined(chartData.statement) && chartData.statement.eventPublish == 'Combined') || component.data == 'DBPull' ){
                    ...
                    recurIndex(component, data1, function(keyIndex){
                        ...
                        // console.log(component.title, component.ySeries, chartData.fixSeries[0])
                        if(component.fixOrder){
                            for(var z in chartData.fixSeries){
                                ...
                                /*if(component.ySeries == 'Resolution')
                                    console.log(val);*/
                                if(isVal){
            ...
            function changeStackedBarValue(component, converted){
                ...
                console.log(component.title, 'chartData', chartData)
            }
                            ...
                            if(data[j].data.length == rowLength){
                                for(var l in keysTopModelArray){
                                    if(keysTopModelArray[l] == component.rowData)
                                        tabData[++index]= dataFormatter.formatUsageData(data[j].data[i][keysTopModelArray[l]],2);
                                    else
            ...
            httpService.get(url+'&db=datadb').success(function(res){
                ...
                for(var i in plotData){
                    ...
                    if(test){
                        ...
                        // console.log('tmp', tmp)
                        // console.log('capacity', plotData[i].capacity, convertToKBMBGB(component, plotData[i].capacity, tmp.gaugeunit) )
    ...
    function timeInterval(component){
        ...
        if($stateParams.params && $stateParams.params.toDate)
            var to = $stateParams.params.toDate+'T00:00:00.000Z'
        else
            var to = $scope.date.end+'T23:59:59.999Z';

        // console.log(from, $stateParams.fromDate, to, $stateParams.toDate, $stateParams)
        var parameter = '';
        parameter += '&fromDate='+ from +'&toDate='+to;
        ...
        // console.log("$stateParams.params",  parameter);
        if($stateParams.paramsArray){
