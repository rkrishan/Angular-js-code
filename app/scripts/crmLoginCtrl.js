...
angular.module('specta')
  .controller('crmLoginCtrl', function($scope, $state, $window, globalConfig, UserProfile, SweetAlert, httpService, md5) {
    ...
    $scope.login = { 'username': 'CRM@link3.net', 'password': 'CRM1234' };
    $scope.validateLogin = function(){
        ...
        .success(function (result, status, headers, config){
            ...
            if( result.trim() == 'Success'){
                ...
                $state.go('index.staticanalysiscrm');
