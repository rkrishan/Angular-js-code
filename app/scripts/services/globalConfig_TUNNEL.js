  ...
  .service('globalConfig', function () {
    ...
    var config = {
        'dev': {
            ...
            clistener: 'http://'+host+':8080/JRServer/CListener?action=query&cid=',
            clistenervps : "http://"+host+":8080/JRServer/CListener?action=querysession&key=",
            clistenerMobility: 'http://'+host+':8080/JRServer/CListenerMobility?action=query&cid=',
            clistenervpsMobility : "http://"+host+":8080/JRServer/CListenerMobility?action=querysession&key=",
