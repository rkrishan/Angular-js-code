  ...
  .service('globalConfig', function ( UserProfile, $filter , $http) {
    ...
    var config = {
        'dev': {
            ...
            host                   : 'https://'+host,
            mapIcon                : 'https://' + host + ':8443',
            NListener              : 'https://'+ host +':8443/DataAPI/NListener',
            dataapiurl             : 'https://'+host+':8443/DataAPI/UIListener?',
            datatablesapiurl       : 'https://'+host+':8443/DataAPI/MListener?action=collections',
            downloadListener       : 'https://'+host+':8443/DataAPI/DownloadListener?trxid=',
            eventServerHost        : host,
            eventServerPort        : 8000,
            snapshoturl            : 'https://'+host+':4000/snapshots/',
            snapshoturlNew         : 'https://'+host+':8443/DataAPI/UISnapshot?',
            pullDataUrl            : 'https://'+host+':8443/DataAPI',
            pullgetcolumn          : 'https://'+host+':8443/DataAPI/MListener?action=getcolumn&id=',
            pullvalidateqry        : 'https://'+host+':8443/DataAPI/MListener?action=validate&qry=',
            pullsaveqry            : 'https://'+host+':8443/DataAPI/MListener?action=savequery&id=',
            pulldataurl            : 'https://'+host+':8443/DataAPI/MListener?action=query&id=',
            pulldataurlbyname      : 'https://'+host+':8443/DataAPI/MListener?action=query&name=',
            pulldatabyRlistener    : 'https://'+host+':8443/DataAPI/RListener?action=',
            pulldatabyMlistener    : 'https://'+host+':8443/DataAPI/MListener?action=',
            clistener              : 'https://'+host+':8443/DataAPI/CListener?action=query&cid=',
            downloadCSR: 'https://'+host+':8443/DataAPI/DownloadCSR?customerid=',
            clistenervps           : "https://"+host+":8443/DataAPI/CListener?action=querysession&key=",
            clistenerMobility      : 'https://'+host+':8443/DataAPI/CListenerMobility?action=query&cid=',
            clistenervpsMobility   : "https://"+host+":8443/DataAPI/CListenerMobility?action=querysession&key=",
            pullfilterdataurl      : 'https://'+host+':8443/DataAPI/MListener?action=filterquery&id=',
            pullfilterdataurlbyname: 'https://'+host+':8443/DataAPI/MListener?action=filterquery&name=',
            dataurl                : 'https://'+host+':8443/DataAPI/listener?action=query&id=',
    ...
    $http.get('https://'+host+':8443/DataAPI/UIListener?'+'collection=system_config&op=select&db=datadb').success(function(res){
        console.log(res);
        if(res.length>0)
            {
