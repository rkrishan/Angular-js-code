...
angular.module('specta')
    .controller('DynamicCtrl', function ($scope, $rootScope, $location, $state, $interval, filterService, $timeout,$sce, $stateParams, $filter, $uibModal, NgMap, globalData, globalConfig, ChartService, SweetAlert, UserProfile, socket, NgTableParams, httpService, dbService, highchartProcessData, currentUser, utility){
    ...
    /*Table*/
        //Column Extended Table(Complex Table)
            ...
            function buildColDataArray(component, data, cb){
                var colDataArray = []
                // console.log(component.title, 'fixOrder', component.fixOrder, $scope.displaydata[component._id].fixOrder);
                if(component.fixOrder){
            ...
            if( component.data != 'DBPull' ){
                ...
                httpService.get(url).then(function(res){
                    ...
                    socket.subscribe(component.query, function(res){
                        var tmp = JSON.parse(res);
                        var data = tmp[component.query];
                        if(angular.isArray(data.event) && component.plotKey){
                ...
                if( component.gauge.data != 'DBPull' ){
                    ...
                    httpService.get(url).success(function(res){
                        ...
                        socket.subscribe(component.gauge.query, function(res){
                            ...
                            if(angular.isArray(data.event) && component.gauge.plotKey){
    ...
    function redirectToOtherPage(params, component){
        console.log("params",params);
        console.log("component",component);
        console.log("$scope.date.start",$scope.date.start);
        console.log("$scope.date.end",$scope.date.end);
